...
import { generateKeys, showMessage, decryptData } from './Functions';
...
function StudentPage() {
    ...
    useEffect(() => {
            ...
            try {
                ...
                axios.get("/api/auth/verify", { headers: { "Content-Type": "application/json", "client_key": btoa(publicKeyPem.replace(/\n/g, '')) }, withCredentials: true })
                    .then(async (resp) => {
                        ...
                        if (user.account_type !== "student") throw new Error("You do not have the required permissions");
        ...
        axios.get("/api/student", { headers: { "Content-Type": "application/json" }, withCredentials: true })
